<?php
	...
	$id = $_GET[cid];
	$sql = q("select * from tbl_job_apply where id ='$id'",$dbconnect);
	$r = f($sql);
	$cnt=nr($sql);
	$fullname=$r['applier_name'];
	$email=$r['email'];

	$sel_mail = "select * from contactus_mail where id=2 and active=1";
	...
	{			
		  ...
		  //------ mail content for commentor -----
			...
			<tr><td colspan='2' style='font-family:Verdana; font-size:12px;'>".$mail_footer."</td></tr>
...
<body>
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0"  class="table_class">
  <tr>
    <td height="22" align="left" class="table_title">Resume reply form</td>
  </tr>
  <tr>
    <td>&nbsp; </td>
  </tr>
  <tr>
    <td align="center" class="txt_content"> 
		...
		<tr class='table_row'>
			<td nowrap="nowrap"><b>Email Id</b></td>
