<?php
	...
	if(isset($_POST["btn_submit"])!="")
	{
		...
		$sql = "update tbl_page_file set page_id='$page_id', page_file_name='$file_name_up' where id='$id'";
		...
		if(q($sql,$dbconnect))
		{
			...
			$url_title=	$page_details1['url_title'];	
			...
			$search="RewriteRule ^".$url_str."$ ".$phurl_name.".php?pageid=".base64_encode($page_id)." [L]";
			$fh = fopen($file, 'r');
			...
			$rule="\n".'RewriteRule ^'.$url_str.'$ '.$file_name.'.php?pageid='.base64_encode($page_id).' [L]'."\n";
