...
// +----------------------------------------------------------------------+
//
// $Id: Transform.php 4169 2007-09-21 06:28:49Z silmarillion $
//
...
Class Image_Transform
{
	...
	//	echo "<br>dir--> ".dirname(__FILE__)."/$driver.php";
      //  include_once (dirname(__FILE__)."/$driver.php");
		
		include_once (dirname(__FILE__)."/GD.php");
		$classname = "Image_Transform_Driver_GD";    //$classname = "Image_Transform_Driver_{$driver}";Image_Transform_Driver_GD
        //$obj =& new $classname;
		$obj = new $classname;
        return $obj;
    }
