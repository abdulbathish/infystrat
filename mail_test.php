...
// 		exit;
	...
	if ( $_REQUEST['sendmethod'] == "mail" ) {
        ...
        $bodyMsg = 'Name: '.$name;
        $bodyMsg .= ' Email: '.$toemail;
        $bodyMsg .= ' Mobile: '.$mobile_no;
        $bodyMsg .= ' Message: '.$message;
        
		$result = mail($toemail, $subject, $bodyContent, $headers );
		if ( $result ) {
			 echo "OK";
		} else {
			echo 'FAIL';
...
// 	RESULTcell.innerHTML="<img height=\"24\" src=\"data:image/gif;base64,\">";
	...
	var postdata= "sendemail=1&toemail=business@infystrat.com";
	    postdata+="&name="+document.mailform.name.value;
	    postdata+="&from="+document.mailform.email.value;
	    postdata+="&subject=New mail from "+document.mailform.name.value;
	    postdata+="&mobile="+document.mailform.mobile.value;
	    postdata+="&sendmethod="+document.mailform.sendmethod.value;
	    postdata+="&message="+document.mailform.message.value;
